...
WORKDIR $GOPATH/src/velmie/wallet-notifications
...
COPY --from=builder /go/src/velmie/wallet-notifications/build/service_notifications /app/service_notifications
