package supplier_outgoing_wire_transfer_has_been_executed
...
const (
	EventName     = "SupplierOutgoingWireTransferHasBeenExecuted"
	TemplateTitle = "supplier outgoing wire transfer has been executed"
)
