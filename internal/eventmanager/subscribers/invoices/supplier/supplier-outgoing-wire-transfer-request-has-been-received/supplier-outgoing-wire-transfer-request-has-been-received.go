package supplier_outgoing_wire_transfer_request_has_been_received
...
const (
	EventName     = "SupplierOutgoingWireTransferRequestHasBeenReceived"
	TemplateTitle = "supplier outgoing wire transfer request has been received"
)
