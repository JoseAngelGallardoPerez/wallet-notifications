package supplier_new_approved_invoices_have_been_uploaded
...
const (
	EventName     = "SupplierNewApprovedInvoicesHaveBeenUploadedByBuyer"
	TemplateTitle = "supplier new approved invoices have been uploaded by buyer"
)
